...
export const LiveProjectsTab = () => {
  const { liveProjects, addLiveProject, updateLiveProject, removeLiveProject } = useCMSStore()
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-bold text-white">Edit Live Project</h3>
        ...
        >
          <Save size={18} /> Save Live Project
        </button>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-xl font-bold text-white">Live Projects</h3>
        <button 
          onClick={handleAdd}
        ...
        {liveProjects.map(proj => (
          <div key={proj.id} className="flex flex-col justify-between p-4 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 transition-colors h-full">
            ...
            <div className="flex items-center gap-2 mt-auto">
              ...
              <button 
                onClick={() => removeLiveProject(proj.id)}
